...
def create_cifar10_CNN_model(activation_function, batch_norm=True):
...
NUM_EPOCHS = 300     # In paper its 300
NUM_RUNS = 5         # In paper its 5
BATCH_SIZE = 256    # In paper its 256
...
for name, activation_func in activations_to_test.items():
    ...
    for bn_state in [True, False]:
        ...
        for r in range(NUM_RUNS):
            ...
            model = create_cifar10_CNN_model(activation_func, batch_norm=bn_state)
